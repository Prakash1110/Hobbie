...
_bsa.flexbar = function (zoneKey, segment, options, ads) {
  ...
  function css(colors) {
    ...
    style +=
      ...
      id +
      " .flexbar-wrap{padding:20px 15px}}";
    if (_bsa.isset(ads[0].custom_css)) style += ads[0].custom_css;
    style += "</style>";
    return style;
  }
...
_bsa.stickybox = function (zoneKey, segment, options, ads) {
  ...
  function css(colors) {
    ...
    c +=
      ...
      id +
      " .stickybox-outer{font-family:-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Oxygen-Sans,Ubuntu,Cantarell,Helvetica Neue,Helvetica,Arial,sans-serif;font-size:12px;max-width:400px;box-shadow:inset 0 0 0 1px hsla(0,0%,100%,.15);position:fixed;bottom:20px;right:20px;z-index:1000}#" +
      id +
      " .stickybox-inner{display:flex;background-color:#121212;padding:.8em;border-radius:4px;text-decoration:none}#" +
      id +
      " .stickybox-banner{position:relative;padding:1em;margin-right:1em;border-radius:4px}#" +
      id +
      " .stickybox-logo{width:auto;height:50px;max-width:none}#" +
      id +
      " .stickybox-description{margin-bottom:.5em;font-size:14px;line-height:1.35;color:#f2f2f2;text-align:left}#" +
      id +
      " .stickybox-company{font-weight:600;text-transform:uppercase;font-size:10px;color:#999;letter-spacing:.4px}#" +
      id +
      " .stickybox-cta{position:absolute;bottom:0;right:0;padding:4px;border-top-left-radius:4px;border-bottom-right-radius:4px;text-align:right;line-height:1;font-size:9px;letter-spacing:.3px;font-weight:600;text-transform:uppercase}#" +
      id +
      "._bsa_hide{display:none}#" +
      id +
      " .native-hide{cursor:pointer;position:absolute;top:-6px;right:-6px;line-height:1;font-size:12px;border-radius:50%;padding:4px 5.42px}";
    if (_bsa.isset(ads[0].custom_css)) c += ads[0].custom_css;
    c += "</style>";
    return c;
  }
  function template(ads) {
    var c = "";
    var companyTagline = _bsa.isset(ads[0].companyTagline)
      ? ads[0].companyTagline
      : _bsa.isset(ads[0].company)
      ? ads[0].company
      : "";
    var statlink = _bsa.link(
      ads[0].statlink,
      segment,
      custom_domain,
      ads[0].timestamp
    ...
    c +=
      ...
      '">';
    c +=
      '<div class="stickybox-banner" style="background-color: ' +
      backgroundColor +
      '">';
    c +=
      '<img height="50" width="125" class="stickybox-logo" src="' + logo + '">';
    c +=
      '<div class="stickybox-cta" style="background-color: ' +
      ctaBackgroundColor +
      "; color: " +
      ctaTextColor +
      ';">' +
    ...
    c += "</a>";
    c +=
      '<div class="native-hide" style="background-color: ' +
      textColor +
      "; color: " +
      backgroundColor +
      "; border: solid 1px " +
...
_bsa.iab = function (zoneKey, segment, options, ads) {
  ...
  function css(colors) {
    ...
    style +=
      ...
      " .z_" +
      zoneKey +
      " ._bsa_iab.rectangle .iab-cta{margin-left:inherit;margin-top:15px}";
    if (_bsa.isset(ads[0].custom_css)) style += ads[0].custom_css;
    style += "</style>";
    return style;
  }
